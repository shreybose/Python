...
class Hand():
    ...
    def adjust_for_ace(self):
        ...
        # check if the value is greater than 21, and still have an ace then change my ace to 1 instead of 11
        while self.value > 21 and self.aces > 0:  # if we have one ace
            self.value -= 10
            self.aces -= 1
